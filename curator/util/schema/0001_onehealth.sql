...
CREATE TABLE relation_types (
    left_type_id        VARCHAR NOT NULL REFERENCES element_types (id)  ON UPDATE CASCADE ON DELETE CASCADE,
    relation_type_id    VARCHAR NOT NULL REFERENCES element_types (id)  ON UPDATE CASCADE ON DELETE CASCADE,
    right_type_id       VARCHAR NOT NULL REFERENCES element_types (id)  ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE field_definitions (
    ...
    element_type_id   VARCHAR NOT NULL REFERENCES element_types(id) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE elements (
    ...
    type_id     VARCHAR NOT NULL REFERENCES element_types (id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE element_mappings (
    ...
    identity_mapping    VARCHAR NOT NULL,
