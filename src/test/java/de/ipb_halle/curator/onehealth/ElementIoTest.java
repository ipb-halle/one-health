...
public class ElementIoTest {
     ...
     */
    private void createElements(ElementHelper helper) {
    ...
    public void testReaderAndWriter() throws Exception {
        ElementHelper helper = new ElementHelper(container);
        helper.deleteElements();
        InputStream input = this.getClass().getResourceAsStream(ELEMENTS_CSV);

        /*
         * for generation of test data use this instead of 'ByteArrayOutputStream output = ...':
         *
