...
public class MetadataController {
     ...
     * return new ResponseEntity<>(metadataService.GetAllAsOptions(),
     * HttpStatus.OK);
     * }
     * 
     * @GetMapping("entity-type/{id}")
     * public ResponseEntity<MetadataElementDTO> GetEntityType(@PathVariable String
     * id) {
     * return new ResponseEntity<>(metadataService.GetEntityType(id),
     * HttpStatus.OK);
     * }
     * 
     * @GetMapping("link-type/{id}")
     * public ResponseEntity<MetadataElementDTO> GetLinkType(@PathVariable String
     * id) {
