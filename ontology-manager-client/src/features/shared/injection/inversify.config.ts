...
import { ILocalStorageStore, ITutorialStore, LocalStorageStore, STORES, TutorialStore } from "../../../stores";
...
dependencyFactory.bind<ILocalStorageStore>(STORES.ILocalStorageStore).to(LocalStorageStore);
