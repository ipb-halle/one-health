...
import { IOntologyService } from '@/features/visualization/co-ocurrence-search/services/visualization-service';
import { SelectableOption } from '../../../core/types/selectable-option';
import TypeQueryBuilder from '../../../features/visualization/co-ocurrence-search/components/type-query-builder';
...
const CoOccurrenceSummaryPageComponent: React.FC = () => {
    const ontologyService = dependencyFactory.get<IOntologyService>(
        SERVICES.IOntologyService,
    );
    const entityService = dependencyFactory.get<IEntityTypeService>(
        SERVICES.IEntityTypeService,
    );
    const { messageService } = useContext(MessageServiceContext);
    const coOcurrenceVisualizationHistoryService =
        dependencyFactory.get<ICoOcurrenceVisualizationHistoryService>(
    ...
    const [queryHistory, setQueryHistory] = useState<
        Partial<ISavedCoOcurrenceVisualization>[]
    >([]);
    ...
    const leftQueryBuilder: RefObject<TypeQueryBuilder> =
        useRef<TypeQueryBuilder>(null);
    const rightQueryBuilder: RefObject<TypeQueryBuilder> =
        useRef<TypeQueryBuilder>(null);
    ...
    const [sankeyData, setSankeyData] =
        useState<Partial<SankeyData>>(emptySankey);
    ...
    const init = async () => {
        ...
        setQueryHistory(
            await coOcurrenceVisualizationHistoryService.getAllAsOptions(
                messageService!,
            ),
        );

        const loaded = await coOcurrenceVisualizationHistoryService.get(
            '0',
            messageService!,
        );
    ...
    const updateData = async (query: any) => {
        ...
        var graph = await ontologyService.getCoOcurrences(
            query,
            messageService!,
        );
    ...
    const downloadOptions = [
        {
            label: 'XLSX',
            command: async () => {
                const results = await ontologyService.getCoOccurrencesDetails(
                    {
                        leftTypeQuery: leftTypeQuery,
                        rightTypeQuery: rightTypeQuery,
                    },
                    messageService!,
                );
    ...
    const accept = async () => {
        ...
        await coOcurrenceVisualizationHistoryService.create(
            savedVisualization,
            messageService!,
        );
        setQueryHistory(
            ...
            return (
                <div
                    ...
                    <Button
                        ...
                        onClick={async (e) => {
                            const loaded =
                                await coOcurrenceVisualizationHistoryService.get(
                                    query.id,
                                    messageService!,
                                );
                            const newData = JSON.parse(loaded.visualization);
                            ...
                            leftQueryBuilder.current!.loadQuery(
                                loaded.query.leftTypeQuery,
                            );
                            rightQueryBuilder.current!.loadQuery(
                                loaded.query.rightTypeQuery,
                            );
                    ...
                    <Button
                        ...
                        aria-label="Cancel"
                        onClick={async (e) => {
                            await coOcurrenceVisualizationHistoryService.delete(
                                query.id,
                            );
                            setQueryHistory(
                                await coOcurrenceVisualizationHistoryService.getAllAsOptions(
    ...
    const sourceColumnTemplate = (edge: any) => {
        return (
            <a
                style={{ textDecoration: 'none', fontSize: 14, paddingLeft: 5 }}
        ...
        <>
            ...
            <div className="page-container-wide">
                ...
                <div className="row g-3 coocurrences-summary">
                    {/* history bar */}
                    <div
                        className="col-2 coocurrences-summary-panel"
                        id="cooccurrences-summary-history">
                    ...
                    <div className="col-10" style={{}}>
                        <div className="coocurrences-summary-panel">
                            <div
                                className="coocurrences-summary-panel-header"
                                id="cooccurrences-summary-toolbar">
                                <div className="p-inputgroup flex-1">
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            updateData({
                                                leftTypeQuery: {
                                                    ...leftQueryBuilder.current!.getQuery(),
                                                },
                                                rightTypeQuery: {
                                                    ...rightQueryBuilder.current!.getQuery(),
                                                },
                                            });
                                        }}
                                        tooltip="Run query"
                                    ...
                                    <Button
                                        icon="pi pi-save"
                                        onClick={() => {
                                            confirmCoOcurrenceVisualizationSave();
                                        }}
                                        tooltip="Save query"
                                        tooltipOptions={{
                                            position: 'bottom',
                                ...
                                <div style={{ marginRight: '85%' }}>
                                    <SplitButton
                                        ...
                                        onClick={async () => {
                                            const results =
                                                await ontologyService.getCoOccurrencesDetails(
                                                    {
                                                        leftTypeQuery:
                                                            leftTypeQuery,
                                                        rightTypeQuery:
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <Plot
                                        ...
                                        onClick={async (event: any) => {
                                            if (
                                                !event.points[0].source ||
                                                !event.points[0].target
                                            )
                                                return;

                                            const newLeftQuery: ITypeQuery = {
                                                ...leftTypeQuery,
                                            };
                                            const newRightQuery: ITypeQuery = {
                                                ...rightTypeQuery,
                                            };

                                            if (newLeftQuery.filters) {
                                                newLeftQuery.filters = [
                                                    ...newLeftQuery.filters!,
                                                    {
                                                        property:
                                                            newLeftQuery.groupBy!,
                                                        value: event.points[0]
                                                            .source.label,
                                                    },
                                                ];
                                            } else
                                            ...
                                            if (newRightQuery.filters) {
                                                newRightQuery.filters = [
                                                    ...newRightQuery.filters!,
                                                    {
                                                        property:
                                                            newRightQuery.groupBy!,
                                                        value: event.points[0]
                                                            .target.label,
                                                    },
                                                ];
                                ...
                                <div
                                    ...
                                    id="cooccurrences-summary-filters">
                                    <TypeQueryBuilder
                                        height={332}
                                        width={'calc(100% - 12px)'}
                                        ref={leftQueryBuilder}
                                        triggerQuery={runQuery}
                                        parentUpdate={(leftQuery: any) => {
                                            setLeftTypeQuery(leftQuery);
                                        }}
                                        messageService={
                                            messageService!
                                        }></TypeQueryBuilder>
                                    <TypeQueryBuilder
                                        height={332}
                                        width={'calc(100% - 12px)'}
                                        ref={rightQueryBuilder}
                                        triggerQuery={runQuery}
                                        parentUpdate={(rightQuery: any) => {
                                            setRightTypeQuery(rightQuery);
                                        }}
                                        messageService={
                                            messageService!
                                        }></TypeQueryBuilder>
                            ...
                            <div
                                ...
                                id="cooccurrences-summary-details">
                                <div
                                    style={{
                                    ...
                                    <DataTable
                                        ...
                                        <Column
                                            field="leftEntity"
                                            header="Left Entity"></Column>
                                        <Column
                                            field="type"
                                            header="Relationship"></Column>
                                        <Column
                                            field="rightEntity"
                                            header="Right Entity"></Column>
                                        <Column
                                            field="sourceName"
                                            header="Source Name"></Column>
                                        <Column
                                            field="sourceUrl"
                                            header="Source URL"
                                            body={
                                                sourceColumnTemplate
                                            }></Column>
                                    </DataTable>
                                </div>
                            </div>
