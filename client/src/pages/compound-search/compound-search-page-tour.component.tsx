...
const CompoundSearchPageTourComponent: React.FC<
    CompoundSearchPageTourProps
> = ({ run, callback }) => {
    ...
    const steps: Array<Step> = [
        {
            content:
                'The compound search page offers multiple methods to search for compounds in the knowledge base.',
        ...
        },
        {
            ...
            content: (
                <div>
                    The structure search panel allows you to search the database
                    for compounds using structural methods. Just draw your
                    target structure using the editor.
                    <img
                        src={compoundDrawGif}
        ...
        },
        {
            ...
            content: (
                <div>
                    You can use the obtained results as a starting point for a
                    more in depth knowledge base exploration.
                    <img
                        src={compoundNeighborhoodGif}
                        style={{ width: '480px', height: '300px' }}
                    />
                </div>
            ),
        ...
        },
        {
            ...
            content:
                'You can access this tutorial at any time by clicking the help button.',
            disableBeacon: true,
