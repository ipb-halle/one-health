...
import { ILinkType } from '../../../features/metadata/link-types';
...
const LinkTypeFormPageComponent: React.FC = () => {
    ...
    const directionOptions = [
        ...
        { name: 'Undirected', value: 'UNDIRECTED' },
    ];

    const [linkType, setLinkType] = useReducer(formReducer<ILinkType>, {
        name: '',
        direction: '',
        leftEntityTypeId: '',
        leftCardinality: '',
            ...
            msgs.current.show([
                {
                    ...
                    content: (
                        <p>
                            This feature is currently in beta and is not fully
                            stable. While we encourage you to explore and
                            provide feedback, please be aware that using this
                            feature will lead to bugs, crashes, or unexpected
                            behavior.
                        </p>
                    ),
                },
    ...
    const init = async (id: string | undefined) => {
        if (id) setLinkType(await linkTypeService.get(id, messageService!));
    ...
    const checkDefinitionValidity = () => {
        if (
            !linkType.name ||
            !linkType.direction ||
            !linkType.leftEntityTypeId ||
            !linkType.leftCardinality ||
            !linkType.rightEntityTypeId ||
            !linkType.rightCardinality
        )
            return false;
    ...
    const onSaveHandler = async () => {
        await linkTypeService.create(linkType, messageService!).then((x) => {
            ...
            <Panel header="Definition" className="mb-4">
                <div className="row mb-4">
                    <div className="col-md-4">
                        <div className="form-group">
                            <label
                                htmlFor="linkType.name"
                                className="font-bold block mb-2 asterisk-mark">
                                Name
                            </label>
                            <InputText
                                value={linkType.name}
                ...
                <div className="row mb-4">
                    <div className="col-md-4">
                        <div className="form-group">
                            <label
                                htmlFor="linkType.leftEntityTypeId"
                                className="font-bold block mb-2 asterisk-mark">
                                Left entity type
                            </label>
                            <Dropdown
                                ...
                                onChange={(e) =>
                                    setLinkType({
                                        ...linkType,
                                        leftEntityTypeId: e.target.value,
                                    })
                                }
                            />
                        </div>
                    ...
                    <div className="col-md-2">
                        <div className="form-group">
                            <label
                                htmlFor="linkType.leftCardinality"
                                className="font-bold block mb-2 asterisk-mark">
                                Left Cardinality
                            </label>
                    ...
                    <div className="col-md-4">
                        <div className="form-group">
                            <label
                                htmlFor="linkType.rightEntityTypeId"
                                className="font-bold block mb-2 asterisk-mark">
                                Right entity type
                            </label>
                            ...
                            <Dropdown
                                ...
                                onChange={(e) =>
                                    setLinkType({
                                        ...linkType,
                                        rightEntityTypeId: e.target.value,
                                    })
                                }
                            />
                        </div>
                    ...
                    <div className="col-md-2">
                        <div className="form-group">
                            <label
                                htmlFor="linkType.rightCardinality"
                                className="font-bold block mb-2 asterisk-mark">
                                Right Cardinality
                            </label>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="form-group">
                            <label
                                htmlFor="linkType.keywords"
                                className="font-bold block mb-2">
                                Keywords
                            </label>

                            <KeywordSearch
                                value={linkType.keywords}
                                valueSetter={(e) =>
                                    setLinkType({
                                        ...linkType,
