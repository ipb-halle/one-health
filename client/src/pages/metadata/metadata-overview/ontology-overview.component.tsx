...
const MetadataOverviewPageComponent: React.FC = () => {
    ...
    const getIcons = () => {
        return (
            <SelectButton
                value={selectedPanel}
                onChange={(e) => setSelectedPanel(e.value)}
                itemTemplate={panelOptionsTemplate}
                optionLabel="value"
            ...
            <div className="row justify-content-center mb-3">
                <div className="col">
                    <OverviewCard
                        ...
                        rightLabel="Types"
                        icon={faCube}
                        actions={entityCardFooter}></OverviewCard>
                </div>
                <div className="col">
                    <OverviewCard
                        ...
                        actions={linkCardFooter}></OverviewCard>
                </div>
                <div className="col">
                    <OverviewCard
