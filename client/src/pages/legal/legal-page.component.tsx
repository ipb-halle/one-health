            ...
            <Accordion multiple activeIndex={activeIndex}>
                <AccordionTab header="Imprint">
                    <p>
                        ...
                        naturalonehealth.org) is developed and operated by the
                        <br />
                        <br />
                    ...
                    <p>
                        ...
                        <br />
                        WWW:{' '}
                        <a href="https://www.ipb-halle.de">www.ipb-halle.de</a>
                        <br />
                    </p>
                    <p>
                        <b>
                            For specific questions regarding N1H.org or this
                            software, please address the developers directly
                            (fbroda@ipb-halle.org, Tel. +49-345-5582-1361).
                        </b>
                    </p>
                </AccordionTab>
                <AccordionTab header="Privacy / GDPR Declaration">
                    <div className="text-container">
                        ...
                        <p>
                            <i>
                                Please note: This text is an automatic
                                translation from a German original text. Its
                                purpose is to inform you about your rights - not
                                to deny any rights to you. This declaration
                                applies to N1H.org, naturalonehealth.org and
                                their sub-domains (hereinafter N1H.org).
                            </i>
                        </p>

                        <h2>Responsible Body</h2>
                        <p>
                            Responsible body for the purpose of the General Data
                            Protection Regulation and other national data
                            protection laws of the EU member states as well as
                            other data and privacy protection regulations is
                            <center>
                                Leibniz Institute of Plant Biochemistry
                                <br />
                                Weinberg 3<br />
                                ...
                                <a href="mailto:datenschutz@ipb-halle.de">
                                    datenschutz@ipb-halle.de
                                </a>
                                <br />
                            </center>
                        </p>
                    ...
                    <div className="text-container">
                        ...
                        <p>
                            N1H.org is aimed at the interested public
                            (scientists, technical staff, students, etc.). The
                            offer can be used anonymously - there is no
                            mechanism for registration or personalization. Even
                            with anonymous use, however, the processing of
                            personal information (namely IP address, time of
                            call, operating system and browser version, URL of
                            the requested resource and referrer) takes place.
                            The temporary storage and processing of this data is
                            necessary for the delivery of the content as well as
                            the technical monitoring of the systems. Obtaining
                            your prior consent to this data processing is
                            regularly actually not possible. The legal basis for
                            the processing and storage of this data is Art. 6
                            para. 1 lit. b or f. GDPR.
                        </p>
                    </div>
                    ...
                    <div className="text-container">
                        ...
                        <p>
                            The purpose of the data processing is the delivery
                            of the content.
                        </p>
                    </div>
                    ...
                    <div className="text-container">
                        ...
                        <p>
                            N1H.org does not use cookies. There is no (external)
                            advertising, tracking pixels, browser
                            fingerprinting, analytics or profiling on N1H.org.
                            We do not load resources from external servers. On
                            N1H.org you cannot buy goods or services and you
                            cannot register personally. There is no transfer of
                            personal data to third parties.
                        </p>

                        <p>
                            To monitor the servers and to support
                            troubleshooting, anonymized log files are created by
                            the servers. The log files are deleted after 7 days
                            at the latest.
                        </p>

                        <p>
                            The N1H.org servers are operated in German data
                            centers.
                        </p>
                    </div>
                    ...
                    <div className="text-container">
                        ...
                        <p>
                            ...
                            subject within the meaning of the GDPR and you are
                            entitled to the following rights towards the
                            operator:
                        </p>
                    </div>
                    ...
                    <div className="text-container">
                        ...
                        <p>
                            You may request confirmation from the operator as to
                            whether personal data concerning you is being
                        ...
                        <p>
                            ...
                            whether the personal data concerning you are
                            ...
                            safeguards pursuant to Art. 46 GDPR in connection
                            with the transfer.
                        </p>
                    </div>
                    ...
                    <div className="text-container">
                        ...
                        <p>
                            You have a right to rectification and/or completion
                            towards the operator if the personal data processed
                            concerning you is inaccurate or incomplete. The
                            operator shall carry out the rectification without
                            undue delay.
                        </p>
                    </div>
                    ...
                    <div className="text-container">
                        ...
                        <p>
                            ...
                            being stored - only be processed with your consent
                            or for the assertion, exercise or defense of legal
                            claims or for the protection of the rights of
                            another natural or legal person or for reasons of
                            important public interest of the Union or a Member
                            State.
                        </p>

                        <p>
                            If the restriction of processing has been restricted
                            in accordance with the above conditions, you will be
                            informed by the operator before the restriction is
                            lifted. In case of data processing for scientific,
                    ...
                    <div className="text-container">
                        ...
                        <p>
                            You may request the operator to delete the personal
                            data concerning you without undue delay, and the
                        ...
                        <p>
                            ...
                            concerning you public and is obliged to delete it
                            pursuant to Article 17(1) of the GDPR, he shall take
                            reasonable steps, including technical measures,
                            having regard to the available technology and the
                            cost of implementation, to inform third party
                            operators that you as the data subject have
                            requested the deletion of the data and all links to
                    ...
                    <div className="text-container">
                        <h2>Right to information</h2>
                        <p>
                            If you have asserted the right to rectification,
                            deletion or restriction of processing against the
                            operator, the operator is obliged to inform all
                            recipients to whom the personal data concerning you
                            have been disclosed of this rectification or
                            deletion of the data or restriction of processing,
                            unless this proves impossible or involves a
                            disproportionate effort.
                        </p>

                        <p>
                            You have the right to be informed about these
                            recipients by the data operator.
                        </p>
                    </div>
                    ...
                    <div className="text-container">
                        ...
                        <p>
                            ...
                            concerning you that you have provided to the
                            operator in a structured, common and
                            machine-readable format. You also have the right to
                        ...
                        <p>
                            ...
                            obtain that the personal data concerning you be
                            transferred directly from one operator to another
                            operator, insofar as this is technically feasible.
                            Freedoms and rights of other persons must not be
                            affected by this.
                        </p>
                    ...
                    <div className="text-container">
                        ...
                        <p>
                            <b>You have the right to object at any time</b>, on
                            grounds relating to your particular situation,{' '}
                            <b>to the processing of personal data</b> concerning
                            you which is carried out on the basis of Article
                            6(1)(e) or (f) GDPR; this also applies to profiling
                            based on these provisions.
                        </p>

                        <p>
                            The operator shall no longer process the personal
                            data concerning you unless it can demonstrate
                            compelling legitimate grounds for the processing
                            which override your interests, rights and freedoms,
                            or the processing serves the purpose of asserting,
                            exercising or defending legal claims.
                        </p>

                        <p>
                            If the personal data concerning you is processed for
                            the purposes of direct marketing, you have the right
                            to object at any time to the processing of personal
                            data concerning you for the purposes of such
                            marketing; this also applies to profiling, insofar
                            as it is related to such direct marketing.
                        </p>

                        <p>
                            If you object to the processing for direct marketing
                            purposes, the personal data concerning you will no
                            longer be processed for these purposes.
                        </p>

                        <p>
                            You have the possibility, in connection with the use
                            of information society services - notwithstanding
                            Directive 2002/58/EC - to exercise your right to
                            object by means of automated procedures using
                    ...
                    <div className="text-container">
                        <h2>
                            Right to revoke your declaration of consent under
                            data protection law
                        </h2>
                        <p>
                            <b>
                    ...
                    <div className="text-container">
                        <h2>
                            Automated decision in individual cases including
                            profiling
                        </h2>
                        <p>
                            You have the right not to be subject to a decision
                        ...
                        <p>
                            ...
                            categories of personal data pursuant to Article 9(1)
                            of the GDPR, unless Article 9(2)(a) or (g) applies
                            and appropriate measures have been taken to protect
                            the rights and freedoms and your legitimate
                            interests.
                        </p>

                        <p>
                            With regard to the cases referred to in (1) and (3),
                            the operator shall take reasonable steps to
                            safeguard the rights and freedoms as well as your
                            legitimate interests, including at least the right
                            to obtain the intervention of a person on the part
                            of the operator, to express his or her point of view
                    ...
                    <div className="text-container">
                        ...
                        <p>
                            ...
                            particular in the Member State of your residence,
                            workplace or the place of the alleged infringement,
                            if you consider that the processing of personal data
                            concerning you infringes the GDPR (Art. 77 GDPR).
                        </p>

                        <p>
                            The supervisory authority to which the complaint has
                            been lodged will inform the complainant of the
                            status and outcome of the complaint, including the
                            possibility of a judicial remedy under Art. 78 GDPR.
                        </p>

                        <p>
                            Supervisory authority to the operator is the state
                            data protection officer of Saxony-Anhalt:
                            <center>
                                <a href="https://datenschutz.sachsen-anhalt.de/datenschutz-in-sachsen-anhalt/">
                    ...
                    <div className="text-container last">
                        ...
                        <p>
                            The data protection declaration has been reviewed by
                            the external data protection officer of the Leibniz
                            Institute of Plant Biochemistry (IPB). The data
                            protection declaration is regularly adapted to
                            current changes in the legal situation or due to
                            legal decisions.
                        </p>
                        <p>
                ...
                <AccordionTab header="Accessibility Statement">
                    <p>
                        N1H.org is primarily targeted at and a tool for
                        international scientists. As such, it is neither
                        appropriate nor possible to adhere to the full extent of
                        accessibility standards. Please also note that the
                        N1H.org web application is work in progress. We're
                        currently re-working our code to improve security, add
                        new functionality and to boost accessibility. We need to
                    ...
                    <p>
                        <b>Feedback</b>
                        <br />
                        If you wish to report accessibility issues, you can
                        contact us preferrably using the developer contact
                        options given in the imprint.
                    </p>
                    <p>
                        <b>Enforcement procedure</b>
                        <br />
                        If you have reported a barrier to us and we have not
                        given you a satisfactory response from your point of
                        view after one month, you can contact the ombudsman's
                        office in accordance with Section 16d of the Disability
                        Equality Act of Saxony-Anhalt (BGG LSA)
                        (ombudsstelle@ukst.de). You can also contact the
                        ombudsman's office using the telephone and postal
                        contact options of the State Office for Accessibility
                        Saxony-Anhalt:
                        <br />
                        <br />
                        <a href="https://www.lf-barrierefreiheit-st.de/">
